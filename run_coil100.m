...
%% Print results
fprintf(1, 'Accuracy result on COIL100 using LLMC: %.2f\n', acc_LLMC * 100);
fprintf(1, 'Accuracy result on COIL100 using SMCE: %.2f\n', acc_SMCE * 100);
fprintf(1, 'Accuracy result on COIL100 using LCR+d: %.2f\n', acc_LCR * 100);